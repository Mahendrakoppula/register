  ...
  return (
    <DefaultLayout>
      <div className="flex  items-center justify-center h-32">
        <h1 className="text-center mb-4 text-2xl font-extrabold text-gray-800  md:text-4xl lg:text-5xl">
      ...
      {loading ? (
        ...
        textStatus && (
          <div className="flex items-center justify-center w-full h-40 text-sm border-dotted border-2 border-gray-100 rounded-md">
