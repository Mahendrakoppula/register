    ...
    <React.Fragment>
      <div className="flex flex-col items-center justify-center w-full h-full space-y-2">
        ...
        <div className="max-w-2xl w-full px-4 py-8 space-y-4rounded-lg sm:px-6 sm:py-8 sm:space-y-6">
          ...
          <ClipboardContainer value={registration as string} />
          ...
          <div className="inline-flex items-center justify-center w-full">
            <hr className="w-full h-1 my-8 bg-gray-200 rounded " />
          ...
          <ClipboardContainer value={upiId as string} />
          <form
...
const ClipboardContainer = ({ value }: ClipboardContainerProps) => {
  // Copy to clipboard
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2.5 text-sm font-medium text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5">
      <h4>{value}</h4>
      <div
        onClick={copyToClipboard.bind(null, value as string)}
