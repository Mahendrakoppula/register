...
export default function Home() {
  ...
  const onKeyNum = React.useCallback(
  ...
  const onKeySpecial = React.useCallback(
    (e: React.KeyboardEvent<HTMLInputElement>) => {
      const regex = /[\d]+/g;
      const rex = new RegExp(/[\W\d]+/g);
    ...
    <React.Fragment>
      ...
      >
        ...
        <div className="mb-6">
          <Wraper label="Residential Address*">
            <textarea
              ...
              onChange={({ target }) => {
                setFieldValue('residentialAddress', target.value);
              }}
              onBlur={handleBlur}
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2">
          ...
          /> */}
          <Wraper label="Church membership">
            <ul className="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex">
                ...
                >
                  <div className="flex items-center pl-3">
                    <Input
                      ...
                      onBlur={handleBlur}
                      value={values.churchMembership ? 'Yes' : 'No'}
                    />
                    <label
                      htmlFor={item.toLowerCase()}
                      className="w-full py-3 ml-2 text-sm font-medium text-gray-900"
        ...
        <div className="grid gap-6 mb-6">
          <Input
            ...
            caption="Supported formats: pdf, doc, docx, jpg, jpeg, png, webp. Max file size 1Mb "
